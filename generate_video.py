...
text_fr = "Bonjour, je suis Nova. Ceci est un test avec structure scène et piste audio."

print("🎬 Sending to Colossyan with scenes + tracks...")
